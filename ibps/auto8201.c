...
int main(int argc, char *argv[])
{
    ...
    while(1)
    {
        ...
        fprintf(fp,"<?xml version=\"1.0\" encoding=\"UTF-8\"?><ebank><RequestHead><Source>IBPS</Source><Destination>HOST</Destination><TransactionId>8201</TransactionId><SendDateTime>20100705163000</SendDateTime><MsgId>12345678901234567890</MsgId></RequestHead><RequestFields><TxId>1021000999962020041340829033</TxId><Ustrd>test</Ustrd></RequestFields></ebank>");
        fclose(fp);
